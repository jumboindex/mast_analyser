...
class Masts:
    ...
    # method for question 2a - return filtered list of mast objects filtered by lease years.
    ...
    # method for question 3a - returns a dictionary with count of masts grouped by tenant name.
    # data is not normalized and variations for tenant names exist. This could be resolved programmatically,
    # but it would be wise to check with the user as variance could be legitimate. In the real world I would get 
    # the user to tidy up data at source or user to correct CSV - normalizing data seems to be outside scope for question.
    ...
    def get_masts_by_lease_range(self, start_date = '01 Jun 1999', end_date = '31 Aug 2007'):
        ...
        # create a list of masts, converting date strings to datetime objects for comparison.
